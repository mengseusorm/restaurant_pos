...
$(document).ready(function () {
    ...
    $(document).on('click', ".online-order-webcart", function () {
        $.fn.openClose('#online-order-cart', 'active', '.xmark-btn');
    });

    $(document).on('click', ".telegram-mini-app-webcart", function () {
        $.fn.openClose('#telegram-mini-app-cart', 'active', '.xmark-btn');
    });
