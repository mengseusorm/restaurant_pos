...
<head>
    ...
    <!-- <link rel="stylesheet" href="{{ asset('themes/default/css/style.css') }}?v={{ filemtime(public_path('themes/default/css/style.css')) }}"> -->
    <!-- <link rel="stylesheet" href="{{ asset('themes/default/css/style.css') }}?v={{ time() }}"> -->
    <!-- <link rel="stylesheet" href="{{ asset('themes/default/css/style.css') }}?v=1.0.2"> -->
