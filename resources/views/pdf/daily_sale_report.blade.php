...
<body>
    ...
    <div class="container">
        <div class="report">
            ...
            <p  style="color: #ff006b;margin: 0px 0px 8px 0px;font-size: 16px;font-weight: bold;">{{ trans('all.label.daily_sale_report', [], 'en') }}</p>
            ...
            <table>
                <thead>
                    <tr>
                        <th>{{ trans('all.label.order_date') }}</th>
                ...
                <tbody>
                    @foreach ($items as $item)
                        @php
                            ...
                            $total_price_with_tax += ($item->total + $item->total_tax);
                        @endphp
                        <tr>
                            ...
                            <td>{{App\Libraries\AppLibrary::flatAmountFormat($item->total + $item->total_tax) }}</td>
                        </tr>
                    @endforeach
                    <tr class="total">
