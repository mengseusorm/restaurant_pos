...
<head>
    ...
    <title>Items Category Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="report">
            ...
            <p  style="color: #ff006b;margin: 0px 0px 8px 0px;font-size: 16px;font-weight: bold;">{{ trans('all.label.items_category_report', [], 'en') }}</p>
                ...
                <tbody>
                    @foreach ($items as $item)
                        @php
                            ...
                            $total_price_with_tax += ($item->total_price + $item->total_tax);
                        @endphp
                        <tr>
                            ...
                            <td>{{ App\Libraries\AppLibrary::flatAmountFormat($item->total_price + $item->total_tax) }}</td>
