...
<body>
    ...
    <div class="container">
        <div class="report">
            ...
            <p  style="color: #ff006b;margin: 0px 0px 8px 0px;font-size: 16px;font-weight: bold;">{{ trans('all.label.payment_report', [], 'en') }}</p>
            ...
            <table>
                <thead>
                    <tr>
                        <th>{{ trans('all.label.payment_method') }}</th>
                ...
                <tbody>
                    @foreach ($items as $item)
                        ...
                        <tr>
                            ...
                            <td>{{ App\Libraries\AppLibrary::flatAmountFormat($item->total_with_tax) }}</td>
