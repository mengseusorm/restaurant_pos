<template>
    <section class="pt-8 pb-16">
        <div class="container max-w-3xl">
            ...
            <TelegramMiniAppTemplateManagerComponent :templateId="page.template_id" />
...
<script>
import TelegramMiniAppTemplateManagerComponent from "../components/TelegramMiniAppTemplateManagerComponent";

export default {
    name: "TelegramMiniAppPageComponent",
    components: { TelegramMiniAppTemplateManagerComponent },
    computed: {
        page: function () {
