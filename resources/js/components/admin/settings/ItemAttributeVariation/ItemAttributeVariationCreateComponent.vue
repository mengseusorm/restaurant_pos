    ...
    <div id="modal" class="modal">
        <div class="modal-dialog">
            <div class="modal-header">
                <h3 class="modal-title">{{ $t("menu.item_attribute_variations") }}</h3>
                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        <div class="form-col-12 sm:form-col-6">
                            <label for="item_attribute_id" class="db-field-title required">{{
                                $t("label.item_attribute")
                            }}</label>
                            <vue-select class="db-field-control f-b-custom-select" id="item_attribute_id"
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            ...
                            <input v-model="props.form.price" v-bind:class="errors.price ? 'invalid' : ''" type="number"
                                step="0.01" id="price" class="db-field-control" />
...
export default {
    name: "ItemAttributeVariationCreateComponent",
    ...
    computed: {
        addButton: function () {
            return { title: this.$t('button.add_item_attribute_variation') };
        },
    ...
    methods: {
        ...
        reset: function () {
            ...
            this.$store.dispatch("itemAttributeVariation/reset").then().catch();
            this.errors = {};
        ...
        save: function () {
            try {
                const tempId = this.$store.getters["itemAttributeVariation/temp"].temp_id;
                this.loading.isActive = true;
                this.$store.dispatch("itemAttributeVariation/save", this.props).then((res) => {
                    appService.modalHide();
