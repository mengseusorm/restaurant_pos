        ...
        <div class="db-table-responsive">
            <table class="db-table stripe">
                ...
                <tr class="db-table-body-tr" v-for="currency in currencies" :key="currency">
                    ...
                    <td class="db-table-body-td">
                        {{ currency.second_currency_exchange_rate }}
                    </td>
                    <td class="db-table-body-td">
                        {{ currency.second_decimal }}
                    </td>
                    <td class="db-table-body-td">
...
export default {
    ...
    methods: {
        ...
        edit: function (currency) {
            ...
            this.loading.isActive = true;
            this.$store.dispatch("currency/edit", currency.id);
            this.props.form = {
                name: currency.name,
                name_kh: currency.name_kh,
                name_cn: currency.name_cn,
                symbol: currency.symbol,
                code: currency.code,
                decimal_places: currency.decimal_places ?? 2,
                is_cryptocurrency: currency.is_cryptocurrency,
                exchange_rate: parseFloat(currency.exchange_rate) || 0,
                second_currency: currency.second_currency,
                second_currency_exchange_rate: currency.second_currency_exchange_rate,
                second_decimal: currency.second_decimal,
                show_exchange_rate_on_invoice: currency.show_exchange_rate_on_invoice
            };
            this.loading.isActive = false;
        },
        destroy: function (id) {
