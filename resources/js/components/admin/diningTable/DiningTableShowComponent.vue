    ...
    <div class="col-12">
        ...
        <div class="db-card">
            ...
            <div class="db-card-body" id="print">
                ...
                <div v-if="diningTable.qr_code" class="my-4">
                    <img class="w-48 sm:w-60 mx-auto" :src="diningTable.qr_code" alt="qrcode">
                </div>
                <div v-else class="my-4 p-4 bg-gray-100 rounded text-center">
                    <p class="text-gray-600">{{ $t('message.qr_code_unavailable') }}</p>
                </div>
