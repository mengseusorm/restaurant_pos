                ...
                <form class="p-4 sm:p-5 mb-5" @submit.prevent="search">
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            ...
                            <Datepicker hideInputIcon autoApply v-model="first_date" :enableTimePicker="true" :key="datePickerKey" :format="datePickerFormat" :is24="isTimePicker24Hour" :monthChangeOnScroll="false" utc="false">
                                <template #am-pm-button="{ toggle, value }">
                                    <button type="button" @click="toggle">{{ value }}</button>
                                </template>
                            </Datepicker>
                        </div>
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            ...
                            <Datepicker hideInputIcon autoApply v-model="last_date" :enableTimePicker="true"
                                :key="datePickerKey" :format="datePickerFormat" :is24="isTimePicker24Hour" :monthChangeOnScroll="false" utc="false">
                                <template #am-pm-button="{ toggle, value }">
                                    <button type="button" @click="toggle">{{ value }}</button>
                                </template>
                            </Datepicker>
...
export default {
    ...
    methods: {
        ...
        search: function () {
            if (this.first_date && this.last_date && this.first_date > this.last_date) {
                [this.first_date, this.last_date] = [this.last_date, this.first_date];
            }

            this.props.search.start_date = this.first_date ? appService.formatDateTimeForFilter(this.first_date) : "";
            this.props.search.end_date = this.last_date ? appService.formatDateTimeForFilter(this.last_date) : "";
            this.list();
        },
        clear: function () {
