    ...
    <div class="col-12">
        ...
        <div class="db-tabDiv active" id="information">
            <div class="row py-2">
                ...
                <div v-if="item.item_kind === 2" class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.duration_minutes') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item.duration || '-' }}</span>
                    </div>
                </div>

                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.stock_management') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{
                ...
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.is_print_menu') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{
                            enums.askEnumArray[item.is_print_menu]
                        }}</span>
                    </div>
                </div>
                ...
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.is_print_label') }}</span>
                        <span class="db-list-item-text w-full sm:w-1/2">{{
                            enums.askEnumArray[item.is_print_label]
                        }}</span>
                    </div>
                </div>
                ...
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.printer_name') }}</span> 
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item?.kitchen_printer?.[0]?.name}}</span> 
                ...
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.ip_printer') }}</span> 
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item?.kitchen_printer?.[0]?.ip }}</span> 
                    </div>
                </div>
                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.port') }}</span> 
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item?.kitchen_printer?.[0]?.port }}</span> 
                    </div>
                </div>

                <div class="col-12 sm:col-6 !py-1.5">
                    <div class="db-list-item p-0">
                        <span class="db-list-item-title w-full sm:w-1/2">{{ $t('label.label_printer') }}</span> 
                        <span class="db-list-item-text w-full sm:w-1/2">{{ item?.label_printer?.name || 'N/A' }}</span> 
                    </div>
                </div>
...
import { itemsReport } from "../../../store/modules/itemsReport";
