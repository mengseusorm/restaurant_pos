                    ...
                    <ul class="flex flex-col gap-2">
                        ...
                        <li class="flex items-start gap-2" v-if="order.payment_status == enums.paymentStatusEnum.PAID">
                            ...
                            <span class="text-heading flex-1">
                                {{ order.pos_payment_method_name ? order.pos_payment_method_name : 'Unpaid' }}
...
import OnlineOrderTokenComponent from "./OnlineOrderTokenComponent";
...
export default {
    ...
    mounted() {
        ...
        this.$store
            .dispatch("onlineOrder/show", this.$route.params.id)
            .then((res) => {
