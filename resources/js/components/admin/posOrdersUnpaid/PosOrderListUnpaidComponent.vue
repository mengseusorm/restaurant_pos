    ...
    <div class="col-12">
        <div class="db-card">
            <div class="db-card-header border-none">
                <h3 class="db-card-title">{{ $t('menu.pos_orders_unpaid') }}</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="searchStatus"
                                v-model="props.search.status" :options="orderStatus"
                                :label-by="(option) => option['name_' + language_code] || option.name"
                        ...
                        <td class="db-table-body-td">
                            ...
                            <td class="db-table-body-td">
                                <div v-if="order.order_dinings && order.order_dinings.length > 0">
                                    <span v-for="dining in order.order_dinings" :key="dining.id" class="db-badge blue ml-2">
                            ...
                            <td class="db-table-body-td hidden-print" v-if="permissionChecker('pos-orders')">
                                <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                    ...
                                    <SmIconDeleteComponent @click="destroy(order.id)" v-if="((branch.show_delete_order_button == statusEnum.ACTIVE && permissionChecker('pos-orders'))) && branch.id"/>
                                </div>
                            </td>
                        </tr>
                    </tbody>
...
export default {
    name: "PosOrderListUnpaidComponent",
    components: {
        TableLimitComponent,
        PaginationSMBox,
        PaginationBox,
    ...
    computed: {
        ...
        pagination: function () {
            return this.$store.getters['posOrderUnpaid/pagination'];
        },
        paginationPage: function () {
            return this.$store.getters['posOrderUnpaid/page'];
        },
        direction: function () {
    ...
    methods: {
        ...
        list: function (page = 1) {
            ...
            this.$store.dispatch('posOrderUnpaid/lists', this.props.search).then(res => {
        ...
        destroy: function (id) {
            appService.destroyConfirmation().then((res) => {
                try {
                    this.loading.isActive = true;
                    this.$store.dispatch('posOrderUnpaid/destroy', { id: id, search: this.props.search }).then((res) => {
                        this.loading.isActive = false;
