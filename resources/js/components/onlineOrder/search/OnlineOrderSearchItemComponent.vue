<template>
    ...
    <section class="mb-16 mt-8">
        <div class="container">
            ...
            <OnlineOrderItemComponent :items="items" :type="itemProps.type" :design="itemProps.design" />
        </div>
    </section>
</template>

<script>
import OnlineOrderItemComponent from "../components/OnlineOrderItemComponent";
import itemDesignEnum from "../../../enums/modules/itemDesignEnum";
import statusEnum from "../../../enums/modules/statusEnum";
import alertService from "../../../services/alertService";
import OnlineOrderLoadingComponent from "../components/OnlineOrderLoadingComponent";

export default {
    name: "OnlineOrderSearchItemComponent",
    components: {
