<template>
    <section class="pt-8 pb-16">
        <div class="container max-w-3xl">
            ...
            <OnlineOrderTemplateManagerComponent :templateId="page.template_id" />
...
<script>
import OnlineOrderTemplateManagerComponent from "../components/OnlineOrderTemplateManagerComponent";

export default {
    name: "OnlineOrderPageComponent",
    components: { OnlineOrderTemplateManagerComponent },
    computed: {
        page: function () {
