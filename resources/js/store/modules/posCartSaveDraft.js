...
export const posCartSaveDraft = {
    ...
    actions: {
        ...
        removeFromDraft: function (context,payload) {
            context.commit('removeFromDraft',payload);
        },
    },
    mutations: {
        ...
        removeFromDraft: function (state,payload) {  
