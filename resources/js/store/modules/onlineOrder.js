...
export const onlineOrder = {
    ...
    actions: {
        ...
        tokenCreate: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/online-order/token-create/${payload.id}`,payload).then((res) => {
                    context.commit('show', res.data.data);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        rejectOrder: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/online-order/reject/${payload.id}`, {
        ...
        countPending: function (context) {
            return new Promise((resolve, reject) => {
                axios.get('admin/online-order/count-pending').then((res) => {
                    if (res.data.status) {
