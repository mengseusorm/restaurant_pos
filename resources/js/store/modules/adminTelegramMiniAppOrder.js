...
export const adminTelegramMiniAppOrder = {
    namespaced: true,
    state: {
        lists: [],
        page: {},
    ...
    actions: {
        lists: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/telegram-mini-app-order';
                if (payload) {
        ...
        save: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post("admin/telegram-mini-app-order", payload).then((res) => {
                    resolve(res);
                }).catch((err) => {
                    reject(err);
                });
        ...
        show: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.get(`admin/telegram-mini-app-order/show/${payload}`).then((res) => {
        ...
        changeStatus: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/telegram-mini-app-order/change-status/${payload.id}`,payload).then((res) => {
                    context.commit('show', res.data.data);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        changePaymentStatus: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/telegram-mini-app-order/change-payment-status/${payload.id}`,payload).then((res) => {
                    context.commit('show', res.data.data);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        tokenCreate: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/telegram-mini-app-order/token-create/${payload.id}`,payload).then((res) => {
                    context.commit('show', res.data.data);
                    resolve(res);
                }).catch((err) => {
                    reject(err);
        ...
        rejectOrder: function (context, payload) {
            return new Promise((resolve, reject) => {
                axios.post(`admin/telegram-mini-app-order/reject/${payload.id}`, {
        ...
        export: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = 'admin/telegram-mini-app-order/export';
                if (payload) {
                    url = url + appService.requestHandler(payload);
                }
        ...
        countPending: function (context) {
            return new Promise((resolve, reject) => {
                axios.get('admin/telegram-mini-app-order/count-pending').then((res) => {
                    if (res.data.status) {
