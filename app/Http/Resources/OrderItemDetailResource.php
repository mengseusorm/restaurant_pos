...
class OrderItemDetailResource extends JsonResource
{
    ...
    {      
        return [
            ...
            'item'                             => new ItemResource($this->orderItem),
            ...
            // 'price'                            => AppLibrary::branchCurrencyAmountFormat($this->price,$this->branch),
            ...
            'total'              => AppLibrary::convertAmountFormat($this->total_price),

            'label_printer'      => kitchenPrinter::find($this->orderItem->label_printer_id)?? null
        ]; 
    }
}
