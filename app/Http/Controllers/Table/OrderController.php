...
class OrderController extends Controller
{
    ...
    {
        try {
            Log::info('TableOrderRequest data: ', $request->all());
    ...
    public function storeOnlineOrder(OnlineOrderOrderRequest $request): \Illuminate\Http\Response|OrderDetailsResource|\Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\Routing\ResponseFactory
    {
        try {
    ...
    public function show(FrontendOrder $frontendOrder): \Illuminate\Http\Response|OrderDetailsResource|\Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\Routing\ResponseFactory
    {
        try {
            ...
            Log::info('FrontendOrder data: ', $frontendOrder->toArray());
