...
class LanguageController extends AdminController
{
    ...
    {
        try {
            $languages = $this->languageService->list($request);
            
            // Check if last_updated parameter was provided and no languages were found
            if ($request->has('last_updated') && $languages->isEmpty()) {
                return response(['status' => true, 'message' => 'No languages updated', 'has_updates' => false], 200);
            }
